...
(students.length == 4 && students[students.length - 1]) == "Виктор" ? document.write("Этот массив мне подходит. <br />") :
...
var signal = "зеленый";
signal == "красный" ? document.write("Надо стоять. <br />") :
signal == "желтый" ? document.write("Надо приготовиться. <br />") :
document.write("Можно идти. <br />")
